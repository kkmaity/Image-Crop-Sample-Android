...
public class CutOut {
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * Get {@link com.imagecroper.ResultActivity} intent to start the activity.
         */
    ...
    /**
     * Gets an Exception from the result data if the {@link ResultActivity} failed at some point
     *
