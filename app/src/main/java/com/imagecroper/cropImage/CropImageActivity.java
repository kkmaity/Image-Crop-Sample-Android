...
package com.imagecroper.cropImage;
...
public class CropImageActivity extends AppCompatActivity
  ...
  private View tvFlipVer;
  private View tvFlipHor;
  private View ivRotateLeft;
  private View ivCropImage;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    tvFlipVer = findViewById(R.id.tvFlipVer);
    tvFlipHor = findViewById(R.id.tvFlipHor);
    ...
    tvFlipVer.setOnClickListener(this);
    tvFlipHor.setOnClickListener(this);
    ivRotateLeft.setOnClickListener(this);
    ivRotateRight.setOnClickListener(this);
    ivCropImage.setOnClickListener(this);
